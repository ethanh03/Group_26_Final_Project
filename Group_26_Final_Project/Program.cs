...
//Old
String connectionString = "Server=tcp:fa23group26finalproject.database.windows.net,1433;Initial Catalog=fa23Group26FinalProject;Persist Security Info=False;User ID=MISAdmin;Password=Brave-lion&53;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";

//String connectionString = "Server=tcp:finalprojectgroup26.database.windows.net,1433;Initial Catalog=fa23Group26FinalProject;Persist Security Info=False;User ID=MISAdmin;Password=Brave-lion&53;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
